...
class _EtudiantHomeState extends State<EtudiantHome> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔵 Navigation sans le bouton de publication
    final screens = [
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildNavItem(Icons.work_outline, Icons.work, "Offres", 2),
                  _buildNavItem(Icons.group_outlined, Icons.group, "Groupes", 3),
                ],
              ),
            ),
          ),
...
// ==================== ActualitesFeedScreen avec thème bleu ====================
                          ...
                          child: Row(
                            children: [
                              Icon(
                                ...
                                color: liked ? primaryBlue : Colors.grey[600],
                                size: 22,
                              ),
